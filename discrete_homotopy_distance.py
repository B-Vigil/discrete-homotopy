...
def poset_visualization(V, E, r_start=0.42, r_end=0.42, chain1=None, chain2=None):
    ...
    highlighting = bool(chain1 or chain2)
    ...
    for n in G.nodes():
        ...
        if in1 and in2:
            ...
            color = "gainsboro" if highlighting else "red"
            opacity = 0.85 if highlighting else 1.0
    ...
    for u, v in G.edges():
        ...
        if in1 and in2:
            ...
            edge_color = "gainsboro" if highlighting else "black"
            #opacity = 0.25 if highlighting else 1.0

        edge_traces.append(go.Scatter(
            x=[x0, x1],
            y=[y0, y1],
            mode="lines",
            line=dict(color=edge_color, width=3.0),
            opacity=opacity,
            hoverinfo="none",
        ))

        # Arrowhead
        x0_adj, y0_adj, x1_adj, y1_adj = offset_arrow(
            x0, y0, x1, y1, r_start, r_end
        )
